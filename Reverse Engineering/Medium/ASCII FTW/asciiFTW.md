...
### Solution
#### What we got ?
- First check out what is the type of this file. We observed it is an ELF 64-bit LSB file. Our method will be gdb tool.
...
- We received a disassembly file. Looking closely, we can figure out lots of hex value being loaded into `BYTE`:
...
- Base on the hint, we can predict that each value can be mapped with a character. So, we will try to make a hex value list and decode it.
...
- The final flag:
    ...
    ![Flag](https://github.com/UITxWoodyNguyen/CTF/blob/main/Reverse%20Engineering/Medium/ASCII%20FTW/ftw3.png?raw=true)
